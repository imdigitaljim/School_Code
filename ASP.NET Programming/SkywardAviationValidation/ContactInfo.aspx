...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div>
                                                                    <asp:Wizard ID="profileForm" runat="server" BackColor="#F7F6F3" 
        ...
        <asp:TextBox ID="confirmEmail" runat="server" 
            Width="265" /><br />
        Password<br />
        <asp:TextBox ID="password" runat="server" Width="265"
           TextMode="Password" /><br />
        Confirm password<br />
        <asp:TextBox ID="confirmPassword" runat="server" Width="265" 
            TextMode="Password" />
        <asp:HiddenField ID="hiddenPassword" runat="server" /></p>
    ...
    <table Width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr><td><p>Card type<br />
            ...
            <td><p>Expiration date<br />
                    ...
                    </asp:DropDownList></p></td></tr></table>
    <p>
        Card number<br />
        <asp:TextBox ID="cardnumber" runat="server" Width="265" 
            TextMode="SingleLine" /><br />
        Cardholder name<br />
        <asp:TextBox ID="cardholder" runat="server" Width="265" 
            TextMode="SingleLine" /><br />
        Address<br />
        <asp:TextBox ID="address" runat="server" Width="265" 
            TextMode="SingleLine" /><br />
        City<br />
        <asp:TextBox ID="city" runat="server" Width="265" 
            TextMode="SingleLine" /><br />
        State<br />
        <asp:TextBox ID="state" runat="server" Width="265" 
            TextMode="SingleLine" /><br />
        Zip<br />
        <asp:TextBox ID="zip" runat="server" Width="265" 
            TextMode="SingleLine" /><br />
    </p>
    ...
    <p>
        ...
        Home airport<br />
        <asp:TextBox ID="homeAirport" runat="server" Width="265" 
            TextMode="SingleLine" /><br />
        Service class<br />
