...
<body class="c4">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <p>
                                ...
                                <asp:Button ID="add" runat="server" Text="Add" OnClick="add_Click" CausesValidation="False"
                                    UseSubmitBehavior="False" />
                                <asp:Button ID="remove" runat="server" Text="Remove" OnClick="remove_Click" CausesValidation="False"
                                    UseSubmitBehavior="False" />
        ...
        <tr valign="top">
            <td align="center" valign="top"><span class="btmmenu"><a href="default.aspx">Home</a>
                | <a href="single.aspx">Individual Reservations</a> | <a href="instructors.aspx">Instructors</a><br />
                &#169; 2009 Big River Kayaking</span> </td>
            <td></td>
        </tr>
    </table>
</body>
